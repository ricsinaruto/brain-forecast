...
class NTD(nn.Module):
    ...
    def forecast(
        ...
        **kwargs,
        ...
        Args:     past: Context tensor (B, C, L_ctx) or tuple whose first element is
        the context. Extra tuple elements (e.g., positions) are ignored.     horizon:
        Number of future steps to generate.     sample_fn: Unused placeholder for API
        parity with autoregressive models.     cond: Optional conditioning channels
        matching the context.     noise_type: Diffusion noise type for reverse sampling.
