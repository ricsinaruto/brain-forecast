...
class TextBPETokenizerTrainer:
    ...
    def __init__(
        ...
        *,
        ...
        plot_distribution_max_texts: Optional cap on how many text samples to
        tokenize when building the histogram. plot_distribution_max_tokens: Optional cap
        on total tokens to count. plot_distribution_path: Optional path to save the
        plot; defaults to     `<save_dir>/token_distribution.png` when save_dir is set.
        """
