...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc=3, ndf=64, n_layers=3, use_actnorm=False):
        ...
        input_nc (int)  -- the number of channels in input images ndf (int)       -- the
        number of filters in the last conv layer n_layers (int)  -- the number of conv
...
class NLayerDiscriminator3D(nn.Module):
    ...
    def __init__(self, input_nc=1, ndf=64, n_layers=3, use_actnorm=False):
        ...
        Parameters:     input_nc (int)  -- the number of channels in input volumes
        ndf (int)       -- the number of filters in the last conv layer     n_layers
        (int)  -- the number of conv layers in the discriminator     use_actnorm (bool)
        -- flag to use actnorm instead of batchnorm
        """
